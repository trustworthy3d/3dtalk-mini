...
public:
    ...
    static int32_t last_retract_length;			//上一次回抽的长度  add by derby 8-29
    static int last_dir;		//上次送丝方向
...
private:
	...
	static void check_last_task();
	static void init_power_down_int();
	static void isr_power_down();
#endif
};
