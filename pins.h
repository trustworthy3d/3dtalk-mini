...
#define ORIG_FAN3_PIN    6 // HE2 pin - GPIO-PH3

//add by andy
#define ORIG_PUMP_PIN			31//6-FAB460-pump control
#define ORIG_FILTER_FAN_PIN		4//9 
//end
...
#define HEATER_3_PIN       30//6    //  EXTRUDER 3 OR Space heating//PC7
...
#define POWER_DOWN_INT_PIN 19 //add by ko
#define POWER_DOWN_TEST_PIN 18 //add by ko
